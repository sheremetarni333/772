...
<div class="popup_before--wrapper">
    ...
    <div class="popup_before--content">
        ...
        <a href="#" target="_blank" class="popup_before--buy_btn popup_before" id="popupGoTotarget">
            Subscribe
        </a>
...
$(document).ready(function () {
    ...
    $('.popup_before--text-buy').text("Abonnieren Sie, um Zugriff auf kostenpflichtige Inhalte zu erhalten:");
    $('.popup_before--buy_btn').text("Abonnieren");
    $('.popup_before--text-free').text("Sie können diesen Artikel auch kostenlos weiterlesen");
    $('.popup_before--read').text("KOSTENLOS LESEN");
